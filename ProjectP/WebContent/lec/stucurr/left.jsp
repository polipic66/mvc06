...
<% }%>
<%  if(pg!=null && pg.indexOf("stucurr.do")>0){ %>
	<link rel="stylesheet" href="admin/admincss/menu01.css">
<% }%>
<%  if(pg!=null && pg.indexOf("lecstu.do")>0){ %>
...
<body>
	<ul>
      ...
      <li class="menu01"><a href="stucurr.do">커리큘럼 보기</a></li>
      <li class="menu02"><a href="lecstu.do">강의 보기</a></li>
