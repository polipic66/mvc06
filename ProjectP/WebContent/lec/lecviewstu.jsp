			...
			<table id="titleteachcurr">
				<tr>
					<td id="lect">
						...
						<input type="text" name="lectitle" id="lectitle" size="30" class="lecinput" value="<%=lectitle %>" readonly="readonly" />
					</td>
					<td>
						<label for="teacher">강사&nbsp;</label>
						<input type="text" name="teacher" id="teachname" size="10" value="<%=teachname %>" readonly="readonly" class="lecinput"/>
					</td>
				</tr>
			</table>
			<table id="catefile">
				<tr>
					<td id="curric">
						...
						<input type="text" name="currname" id="currname" value="<%=currname%>" readonly="readonly" />
					</td>
					<td>
						<label for="leccategory" id="category">카테고리&nbsp;</label>
						<input type="text" name="leccategory" id="leccategory" class="lecinput" value="<%=leccategory %>" readonly="readonly" />
					</td>
				</tr>
			</table>
			<div class="divtxtarea">
				<textarea name="leccontent" id="leccontent" cols="90" rows="25" class="test" readonly="readonly"><%=leccontent %></textarea>
			</div>
			<div class="divsubcan">
				<input type="button" value="목록으로" id="button" onclick="" />
			</div>
		</form>
	</div>
</body>
