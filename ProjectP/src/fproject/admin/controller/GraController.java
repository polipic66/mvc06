...
import fproject.admin.dao.GraDao;
//import fproject.admin.dao.ProDao;
import fproject.admin.model.GraDto;
...
/**
 * Servlet implementation class GraController
 */

public class GraController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	ArrayList<GraDto> graList = null;   
	GraDao gradao = null;
	int pagesize = 10;
	ArrayList<GraDto> topList = null;
...
request.setCharacterEncoding("UTF-8");
		...
		*/
		...
		request.setAttribute("pg", "/admin/adminsub3.jsp");
